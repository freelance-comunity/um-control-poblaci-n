		...
		<div class="wrapper">
			<div class="container">
				...
				<div class="content-primary">
					<h1 class="title">Página no permitida</h1>
					<p class="description">Usted no tiene suficientes privilegios para acceder al contenido que esta solicitando.</p>
					<div class="section-footer">
						<a href="{{url('home')}}" class="btn btn-primary">Regresar a Inicio</a>
