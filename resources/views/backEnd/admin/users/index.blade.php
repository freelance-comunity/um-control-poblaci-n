        ...
        <table class="table pmd-table table-hover table-striped display responsive nowrap" cellspacing="0" width="100%">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $item->email }}</td>
              <td>
                <a href="{{ url('users/' . $item->id . '/edit') }}" class="btn pmd-ripple-effect btn-primary">Actualizar</a> {!! Form::open([ 'method'=>'DELETE', 'url' => ['users', $item->id], 'style' => 'display:inline' ]) !!} {!! Form::submit('Eliminar',
