@extends('layouts.ui') @section('title') Crear nuevo Plantel @stop @section('title-section') Crear nuevo Plantel @stop @section('content')
<div class="uk-container uk-container-small">
  <div uk-grid class="uk-child-width-3-4@s uk-child-width-3-4@l">
    <div>
      <div class="uk-card uk-card-default">
        <div class="uk-card-header">
          <h1>Crear Nuevo Plantel</h1>
        </div>
        <div class="uk-card-body">
          <div class="uk-overflow-auto">
           {!! Form::open(['url' => 'admin/campus', 'class' => 'form-horizontal', 'id' => 'validationForm']) !!}
