@extends('layouts.ui') @section('title') Planteles @stop @section('title-section') Planteles @stop @section('content')
<div class="uk-container uk-container-small">
  <div uk-grid class="uk-child-width-2-4@s uk-child-width-2-4@l">
    <div>
      <div class="uk-card uk-card-default">
        <div class="uk-card-header">
          <h1 class="uk-heading-primary">Planteles <a style="float:right;" href="{{ url('admin/campus/create') }}" class="uk-button uk-button-primary uk-button-large">Agregar Nuevo Plantel</a></h1>
        </div>
